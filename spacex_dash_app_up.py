...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(dcc.RangeSlider(id='payload-slider',min=0, max=10000, step=1000,
                                                        marks={0: '0',100: '100',1000: '1000',2000: '2000',3000: '3000',4000: '4000',5000: '5000',6000: '6000',7000: '7000',8000: '8000',9000: '9000',10000: '10000'},
...
def get_pie_chart(site):
    ...
    if site=='ALL':
        ...
        names='Launch Site',
        title='Success count pie for all launch sites')
        return fig
    else:
        ...
        fig = px.pie(df1, values='class count', names='class', title=f"Successful count pie for{site}")
        return fig    
